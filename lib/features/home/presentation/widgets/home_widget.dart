...
class HomeWidget extends StatelessWidget {
  ...
  const HomeWidget({super.key, this.receipt, this.onTap, this.onDelete});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: onTap,
        child: Dismissible(
          key: Key(info?.receiptNumber ?? ''),
          background: Container(
            padding: .all(16),
            color: Colors.redAccent,
            child: Align(alignment: .centerEnd, child: Text('Delete')),
          ),
          ...
          confirmDismiss: (direction) async => showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text('You are about to delete this item, Are you sure?'),
              actions: [
                TextButton(
